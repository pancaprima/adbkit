var ClearCommand, Client, Connection, ForwardCommand, FrameBufferCommand, GetDevicePathCommand, GetFeaturesCommand, GetPackagesCommand, GetPropertiesCommand, GetSerialNoCommand, GetStateCommand, HostBackupCommand, HostRestoreCommand, HostConnectCommand, HostDevicesCommand, HostDevicesWithPathsCommand, HostDisconnectCommand, HostKillCommand, HostTrackDevicesCommand, HostTransportCommand, HostVersionCommand, InstallCommand, IsInstalledCommand, ListForwardsCommand, ListReversesCommand, LocalCommand, LogCommand, Logcat, LogcatCommand, Monkey, MonkeyCommand, Parser, ProcStat, Promise, RebootCommand, RemountCommand, ReverseCommand, RootCommand, ScreencapCommand, ShellCommand, StartActivityCommand, StartServiceCommand, Sync, SyncCommand, TcpCommand, TcpIpCommand, TcpUsbServer, TrackJdwpCommand, UninstallCommand, UsbCommand, WaitBootCompleteCommand, WaitForDeviceCommand, debug;
...
HostBackupCommand = require('./command/host-transport/backup');

HostRestoreCommand = require('./command/host-transport/restore')
...
Client = (function() {
  ...
  Client.prototype.backup = function(serial, file, callback) {
    return this.transport(serial).then(function(transport) {
      return new HostBackupCommand(transport).execute(file);
    }).nodeify(callback);
  };

  Client.prototype.restore = function(serial, file, callback) {
    return this.transport(serial).then(function(transport) {
      return new HostRestoreCommand(transport).execute(file);
    }).nodeify(callback)
  }
